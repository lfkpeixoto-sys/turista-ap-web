...
export default function Planos() {
  ...
  function cancelarAssinatura() {
    ...
    const ok = confirm(
      "Tem certeza que deseja cancelar? Você voltará para o plano Básico."
    );
    if (!ok) return;
    ativarPlano("basico");
  }
        ...
        <div className="planos-page">
          ...
          <div className="planos-grid">
            {PLANOS.map((plano) => (
              <div
                key={plano.id}
                className={`plano-card theme-${plano.theme} ${
              ...
              >
                <div className="plano-top">
                  ...
                  <div className="plano-badges">
                    {plano.current && (
                      <span className="badge green">Plano Atual</span>
                    )}
                    {plano.badge && (
                      <span className="badge orange">{plano.badge}</span>
                    )}
                  </div>
                </div>
                ...
                <div className="plano-rank">
                  <span>Ranking</span>
                  <strong>
                    x{String(plano.rankMult).replace(".", ",")} pontos
                  </strong>
                </div>
                ...
                {payMethod === "pix" ? (
                    ...
                    <div className="pay-box">
                      ...
                      <div className="pay-row">
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() => ativarPlano(selectedPlan.id)}
                        >
                          Já paguei
                        </button>
                      </div>
                      <div className="pay-hint">
                        Pagamento via Pix. (mock) Clique “Já paguei” para ativar.
                      </div>
                    </div>
                  ...
                  <div className="pay-body">
                    <div className="pay-box">
                      ...
                      <div className="pay-hint">
                        Pagamento (mock). Clique “Pagar agora” para ativar.
                      </div>
                    </div>
                    ...
                    <div className="pay-note">
                      ...
                      <div className="pay-resume">
                        ...
                        <div>
                          <span>Total</span>
                          <strong>{`R$ ${selectedPlan.preco.toFixed(
                            2
                          )}`}</strong>
                        </div>
                        <div>
